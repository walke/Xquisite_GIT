...
public class MainActivity extends Activity {
   ...
   boolean interSkip=false;
    ...
    public int userLanguage=0;//0:ENG, 1:NOR
    public boolean languageSelected=false;
    ...
    /**
     * function is executed on dialog reaction that asks user to pick a language
     * @param lng button choice
     */
    public void lngBut(int lng)
    {
        Log.d("MAIN","dia");
    ...
    public void glTouch(int extra)
    {
        ...
        if(interInit && mCurrentAction!=-1){return;}*/interSkip=true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* Thread languageWait=new Thread(new Runnable() {
            @Override
            public void run() {
        ...
        //DATABASE
        mDeviceData=new DeviceData(this,0);
        mDeviceData_NO=new DeviceData(this,1);
        mDBmanager = new DBmanager(this,mDeviceData,mDeviceData_NO);
